...
```ts
// note: the import type is a named import instead of a default import
...
For many routine operations, you require `pchain-types-js` and `bn.js` in conjunction with this package.
...
const transferSuccess = await pchain.transferToken(
...
Retrieves a TransactionResult object given on transaction hash.
...
```ts
// separately prepare the signingKeypair and nonce
...
Convenience method for calling a smart contract method that changes state.
...
// refer to the relevant smart contract for details
// e.g. https://github.com/parallelchain-io/example-smart-contracts/tree/main/chapter_1
const {
...
// pass arguments based on the smart contract method signature
// refer to the relevant smart contract for details
// e.g. ttps://github.com/parallelchain-io/example-smart-contracts/tree/main/chapter_1
...
// use the BinaryReader class (available from pchain-types-js) to decode the return value of type String
...
// use the getAccountBalance method to inspect the updated balance
